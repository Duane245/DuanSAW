...
Use the title and DOI of the corresponding Zenodo release record. The rename
does not create a new release or change previously archived code. For work based
on a modified version, also identify the source version and any relevant commit.

| Version | Version DOI |
| --- | --- |
| v0.4.0 | [10.5281/zenodo.20635934](https://doi.org/10.5281/zenodo.20635934) |
| v0.3.0 | [10.5281/zenodo.20545009](https://doi.org/10.5281/zenodo.20545009) |
| v0.2.0 | [10.5281/zenodo.20380701](https://doi.org/10.5281/zenodo.20380701) |
| v0.1.0 | [10.5281/zenodo.20362279](https://doi.org/10.5281/zenodo.20362279) |

The [concept DOI](https://doi.org/10.5281/zenodo.20362278) identifies the project
across versions; prefer a version DOI when citing a computational result.
...
@misc{duan_saw_2026_v040,
  ...
  month        = jun,
  publisher    = {Zenodo},
  howpublished = {Computer software, version 0.4.0},
  doi          = {10.5281/zenodo.20635934},
  url          = {https://doi.org/10.5281/zenodo.20635934}
}
```
